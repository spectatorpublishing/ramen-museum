export const day_articles = [
    {
        ...
        I decided to go to <a id="monday-link" href="https://lemondenyc.com/" target="_blank">Le Monde</a>, a French restaurant that is walking distance from campus. I ordered take-out and brought it back to my dorm, and enjoyed a filling meal. 
    ...
    },
    {
        ...
        `,
        tuesday3:`In the evening, I decided to reward myself with some quality time with friends at <a href="https://www.chelseamarket.com/" target="_blank">Chelsea Market</a>. It took some time to gather everyone and reach the popular food-heaven, and by the time we got there we were ravenous. 
    ...
    },
    {
        ...
        I rushed back to my dorm for some quick, gourmet late-night study fuel. The <a href="https://ramenmuseum.nyc/" target="_blank">Ramen Museum</a> ramen kits I ordered earlier this week arrived today, and I prepared the Black Mayu Pork Kimchi one right away.`,
    ...
    },
    {
        ...
        thursday3:`For dinner, I didn’t really feel like going out. After a full day on the grind, I needed something quick and easy so I decided to treat myself to some pasta from <a href="https://www.serafinarestaurant.com/" target="_blank">Serafina</a>, which I ordered from UberEats. 
    ...
    },
    {
        ...
        I remember my positive experience with <a href="https://ramenmuseum.nyc/" target="_blank">Ramen Museum NYC</a> and the leftover ramens I had ordered and stored, and suggested a roommate bonding night where we cook our food and eat together. 
        It’s been a stressful week, and all I want is a relaxing night-in making easy, quick, and heartwarming ramen with the people I love. All that bonding made me think of my parents
        who live in Idaho and can't come visit me often in NYC. I remembered when I ordered the ramen earlier in the week that Ramen
        Museum New York delivered to the contiguous 48 states and decided to ship them a few of my favorites so they could enjoy it as well.
        `,
