    ...
    return (
        <div id="Tuesday">
            <DayOfWeek>Tuesday</DayOfWeek>
                        ...
                        <ButtonCont> 
                            <SwipeBtn value= "#Monday" onClick={(e)=>swipe(e)}><img alt="Back arrow" src={leftArr}/>MONDAY</SwipeBtn> <SwipeBtn value= "#Wednesday" onClick={(e)=>swipe(e)}>WEDNESDAY <img alt="Forward arrow" src={rightArr}/></SwipeBtn>
                        </ButtonCont>  
