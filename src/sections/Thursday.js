    ...
    return (
        <div id="Thursday">
            <DayOfWeek>Thursday</DayOfWeek>
                        ...
                        <ButtonCont> 
                            <SwipeBtn value= "#Wednesday" onClick={(e)=>swipe(e)}><img alt="Back arrow" src={leftArr}/>WEDNESDAY</SwipeBtn> <SwipeBtn value= "#Friday" onClick={(e)=>swipe(e)}>FRIDAY<img alt="Forward arrow" src={rightArr}/></SwipeBtn>
                        </ButtonCont>  
            <Vector src={vectors}/>
        </div>
    )
